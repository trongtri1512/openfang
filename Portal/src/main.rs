...
async fn main() {
    ...
    let app = axum::Router::new()
        ...
        .route("/api/portal/system/agents", axum::routing::get(handlers::portal_system_agents).post(handlers::portal_create_agent))
        .route("/api/portal/system/agents/{id}", axum::routing::delete(handlers::portal_stop_agent))
